...
export default function InstructorError({
    ...
    useEffect(() => {
        console.error("Instructor page error:", error);
    }, [error]);
            ...
            <div className="max-w-md w-full bg-white rounded-2xl shadow-lg border border-gray-100 p-8 text-center">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <Link
                        ...
                        className="w-full px-5 py-2.5 bg-gray-100 text-gray-700 font-medium rounded-xl hover:bg-gray-200 transition-colors inline-block"
                    >
                        Back to Dashboard
                    </Link>
                </div>
